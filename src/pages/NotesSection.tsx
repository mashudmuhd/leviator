  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto w-full grid grid-cols-1 md:grid-cols-12 gap-8 items-center relative z-10">
        ...
        <AnimatedSection preset="slideLeft" className="md:col-span-7 space-y-4 sm:space-y-6">
          ...
          <div className="flex flex-wrap gap-1.5 sm:gap-2 pt-1">
            {categories.map((cat) => (
              <button
                ...
                className={`px-3 py-1.5 sm:px-4 sm:py-2 rounded-full text-[11px] sm:text-xs font-medium tracking-wide transition-all duration-300 ${
          ...
          <div className="space-y-3 sm:space-y-4 pt-1">
            {filtered.top.length > 0 && (
              <GlassCard className="space-y-3 p-4 sm:p-6 border-l-4 border-l-amber-500">
            ...
            {filtered.heart.length > 0 && (
              <GlassCard className="space-y-3 p-4 sm:p-6 border-l-4 border-l-purple-500">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
            ...
            {filtered.base.length > 0 && (
              <GlassCard className="space-y-3 p-4 sm:p-6 border-l-4 border-l-emerald-500">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
