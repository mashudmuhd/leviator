  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto w-full grid grid-cols-1 md:grid-cols-12 gap-8 items-center relative z-10">
        ...
        <AnimatedSection preset="slideRight" className="md:col-span-6 space-y-6">
          ...
          <p className="text-sm sm:text-base text-neutral-300 leading-relaxed max-w-md">
            Every drop of <span className="text-brand-gold font-semibold">{activeVariant.name}</span> is formulated with raw botanical extractions harvested across four continents during peak solar alignings.
          </p>
